...
Attack TypeProtocolDetection MethodDNS TunnelingDNSRule-based + MLPayload ExfiltrationICMPRule-based + MLHeader ExfiltrationHTTPRule-based + ML
...
🚀 How to Run
Prerequisites
bashpip install pandas scikit-learn joblib pyshark
Step 1: Extract Features (if running on new PCAPs)
bashpython features/extract_features.py
Step 2: Train the Model
bashpython ml/train_model.py
Step 3: Run the Detector
bashpython demo/run_detector.py
Sample Output
